...
window.download = function () {
  ...
  a.download = 'test.png';
  a.href = document.querySelector("#draw-canvas").toDataURL();
  a.click();
};
...
function displayContent (content) {
  ...
  elem.show();
  html2canvas(elem[0], { height: 5385, width: 2265 }).then(displayOnCanvas);
}
